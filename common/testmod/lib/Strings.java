...
public class Strings {
	...
	/* Items */
	public static final String ITEM_STRANGE_CRYSTAL_DUST_NAME = "dustStrangeCrystal";
	public static final String ITEM_QUARTZ_DUST_NAME = "dustQuartz";
	...
	public static final String BLOCK_META_NAME = "blockMeta";
	public static final String[] BLOCK_META_NAMES = new String[] {
			"1", "2", "3", "4", "5", "6", "7", "8"
	};
	
	public static final String BLOCK_TE_TEST_NAME = "blockTileTest";
	...
	/* Tile Entities */
	public static final String TE_TILETEST_NAME = "tileTETest";
